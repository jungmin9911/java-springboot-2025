...
public class Spring02Application {
	...
	public static void main(String[] args) throws IOException {
		...
		// FileOutputStream output = new FileOutputStream("C:\\temp\\test.txt");	생성완료
		...
		output.close();
		System.out.println("FileOutputStream 파일생성 완료");
		...
		fw.close();
		System.out.println("FileWriter 파일생성 완료");
		...
		pw.close();
		System.out.println("PrintWriter 파일생성 완료");
		...
		fw2.close();
		System.out.println("FileWriter 추가모드 파일생성 완료");
		...
		pw2.close();
		System.out.println("PrintWriter 추가모드 파일생성 완료");
		...
		input.close();
		System.out.println("FileInputStream 파일읽기 완료");
		...
		br.close();
		System.out.println("BufferedReader 파일읽기 완료");
	}
